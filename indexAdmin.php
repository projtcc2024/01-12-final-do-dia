...
<span class="close" id="close-popup">&times;</span>
    ...
    <div class="services-container">
        <div class="services-box floatupcard">
            ...
            <p>Formado pela faculdade de (nome da faculdade) por x anos (outras informações).</p>
        ...
        <div class="services-box floatdowncard">
            ...
            <h3>Carpintaria</h3>
            <p>Me tornei um carpinteiro por tal e tal motivo... (já fiz tal e tal projeto).</p>
        ...
        <div class="services-box floatupcard">
            ...
            <h3>Designer</h3>
            <p>Me tornei designer por tal e tal motivo, e me inspirei em tal e tal coisa para construir o design dos produtos.</p>
